...
public class GerenciadorDeSessaoTest {
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesTerminandoDentroDoHorarioDeUmaSessoaJaExistente() {
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
	...
	public void garanteQueDeveNaoPermitirUmaSessaoQueTerminaNoProximoDia() {
		...
		GerenciadorDeSessao gerenciador = new GerenciadorDeSessao(sessoes);
		Sessao sessao = new Sessao(LocalTime.parse("23:30:00"), rogueOne, sala3D);
		Assert.assertFalse(gerenciador.cabe(sessao));
	}
}
